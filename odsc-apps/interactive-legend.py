...
for department, color in zip(dept_list, Accent7):
	...
	p.circle('wm_x', 'wm_y', source=source, color=color, alpha=0.8, muted_alpha=0.2, legend=department)
